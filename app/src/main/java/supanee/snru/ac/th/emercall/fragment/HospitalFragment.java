...
import supanee.snru.ac.th.emercall.utility.HospitalAdapter;
...
//        Create ListView
        ...
        int[] ints = new int[]{R.drawable.station1, R.drawable.station2, R.drawable.station3, R.drawable.station4,
